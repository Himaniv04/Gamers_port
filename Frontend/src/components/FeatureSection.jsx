...
const FeatureSection = () => {
  return (
    <section className="py-10 md:py-18 px-2 bg-gray-900 features">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="gaming-font text-4xl md:text-6xl mb-2 text-white">
            WHY <span className="gaming-font text-[#00F7FF]">GAMER'S PORT</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              key={index}
              className="bg-gray-800/50 backdrop-blur-sm py-6 px-4  md:py-10 rounded-lg border border-gray-700 hover:border-[#00F7FF] transition-all duration-300 group will-change-transform"
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center text-[#00F7FF] mb-4 mx-auto bg-gray-800 rounded-full">
                <i className={`${feature.icon} ri-2x`} />
              </div>
              <h3 className="text-lg md:text-xl text-center text-white mb-2">
                {feature.title}
              </h3>
